...
numeric utilities
reused by more than one structural module (_beam_gauss_solve, the shared
5-point Gauss-Legendre quadrature nodes, _nice_ticks, _find_diagram_maxima,
make_shape_fn), and the ZoomCanvas pan/zoom widget.
...
INIT_DH   = 200         # initial diagram canvas height
